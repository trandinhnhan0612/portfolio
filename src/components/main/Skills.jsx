...
{
  /* <div className="ml-[18px] md:mx-auto mt-8 grid grid-cols-1 md:grid-cols-2 gap-y-8 md:max-w-[900px]">
  <div
    data-aos="fade-right"
    data-aos-duration="1800"
    className="flex gap-x-3 justify-center items-center w-[300px] md:w-[360px] h-[110px] bg-[#161b22] p-3 rounded-lg"
  >
    <figure className="w-[50px] h-[50px]">
      <img src="/src/assets/images/frontend.jpeg" alt="" />
    </figure>
    <div>
      ...
      <p className="text-gray-400 text-[13px] md:text-[15px] font-[400]">
        Knowledge about front end language: HTML, CSS(SCSS), Javascript
      </p>
    </div>
  </div>
  <div
    data-aos="fade-left"
    data-aos-duration="1800"
    className="flex gap-x-3 items-center w-[300px] md:w-[360px] h-[110px] bg-[#161b22] p-3 rounded-lg"
  >
    <figure className="w-[50px] h-[50px]">
      <img src="/src/assets/images/react.png" alt="" />
    </figure>
