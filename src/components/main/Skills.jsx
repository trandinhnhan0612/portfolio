    ...
    <section id="skill">
      <div className="container">
        <div className="p-3">
          ...
          <div className="mx-auto mt-8 grid grid-cols-1 md:grid-cols-2 gap-y-8 max-w-[900px]">
            <div
              data-aos="fade-right"
              data-aos-duration="1800"
              className="flex gap-x-3 items-center w-[300px] md:w-[360px] h-[110px] border border-solid border-gray-300 p-3 rounded-lg hover:bg-gray-200 hover:bg-opacity-10"
            >
              <figure className="w-[50px] h-[50px]">
                <img src="/src/assets/images/frontend.jpeg" alt="" />
              </figure>
              <div>
                <h5 className="text-smallTextColor text-[13px] font-[700]">
                  HTML/CSS(SCSS)/JAVASCRIPT
                </h5>
                <p className="text-gray-400 text-[13px] font-[400]">
